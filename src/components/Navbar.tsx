...
import { Home, Search, Info, Wrench, icons, WandSparkles } from "lucide-react";
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { name: "AI Finder", path: "/aifinder", icon: WandSparkles },
    { name: "About", path: "/about", icon: Info },
  ];

  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-background/30 backdrop-blur-md">
