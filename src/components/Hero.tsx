  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20 lg:pt-40 lg:pb-28">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full max-w-7xl pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[500px] hero-glow opacity-50 blur-3xl" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm">
          ...
          <span className="text-sm font-medium text-muted-foreground">The New Home for Open Source</span>
        </div>
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
          Woorf is the community-driven hub for finding, sharing, and supporting the best FOSS alternatives and tools.
        </p>
